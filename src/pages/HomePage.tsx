                          ...
                          <tr key={record.id} className="border-b border-border bg-secondary/10">
                            ...
                            <td className="py-2 px-4 align-middle">
                              <input
                                ...
                                className="w-full px-2 py-1 border border-input rounded focus:outline-none focus:ring-1 focus:ring-ring text-sm"
                              />
                            </td>
                            <td className="py-2 px-4 align-middle">
                              <input
                            ...
                            <td className="py-2 px-4 align-middle">
                              <input
                                ...
                                onChange={handleEditFormChange}
                                className="w-full px-2 py-1 border border-input rounded focus:outline-none focus:ring-1 focus:ring-ring text-sm text-right"
                                step="0.01"
                                min="0"
                              />
                            </td>
                              ...
                              <div className="flex flex-col gap-1">
                                ...
                                {editFormData?.paymentMethod?.type === 'organization' && (
                                  <select
                                    ...
                                    className="mt-1 px-2 py-0.5 border border-input rounded text-xs"
                                  >
...
const AddCarWashModal: React.FC<AddCarWashModalProps> = ({ onClose, selectedDate, prefilledData, clickPosition }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('handleSubmit вызван с formData:', formData);
          ...
          <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-border">
            ...
            <button
              ...
              onClick={(e) => {
                ...
                // Не preventDefault здесь - пусть форма отправляется естественным образом
              }}
            >
              {loading ? (
                <>
